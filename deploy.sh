...
# This script is heavily based on this document:
...
function doCompile {
    # At this point, bikeshed has already been run (see .travis.yml).
    # Here, we merely do some cleanup.

    # Clean out existing contents
    rm -rf out/specification/common/index.html
    rm -rf out/specification/generic/index.html
...
# If there are no changes to the compiled out (e.g. this is a README update), bail.
...
git add -A .
git commit -m "Automated update of GitHub Pages: ${SHA}"
